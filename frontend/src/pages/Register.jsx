    ...
    <div className="min-h-screen pt-20 pb-12 flex items-center justify-center bg-gradient-to-br from-background via-blue-50 to-white px-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Join CCMS to report and track community issues</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  type="email" required className="input-field pl-10" placeholder="you@example.com"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <textarea 
                required className="input-field pl-10 py-2 min-h-[80px]" placeholder="123 Main St, City, State, Zip"
